...
|---|---|---|
| [Alpine.js](./alpine_js_guide/) | 3.15.12 | Alpine.js — reatividade, transições, plugins, integração com Rust |
...
| [PostgreSQL](./postgres_guide/) | 18.4 | DDL, DML, MVCC, RLS, replicação, índices, backup, tuning |
...
| [sniffCSS](./sniff_guide/) | 1.0.0 | Uso da ferramenta pela IA — captura, diff, checks (MCP + CLI) |
...
| [Web API](./web_api_guide/) | MDN v2.0 (2026) | Documentação de APIs — templates, macros, interdependências, padrões |
| [Web Performance](./web_performance_guide/) | 2.0.0 | Core Web Vitals, CRP, caching, lazy loading, RAIL |
| [Web Security](./web_security_guide/) | 2.0.0 (2026) | CSP, CORS, HSTS, WebAuthn, cookies, Privacy Sandbox, TLS 1.3 |
| [XML](./web_xml_guide/) | 1.0 (2025) | XML, XPath, XSLT, EXSLT, OpenSearch, segurança, parsing |

Cada guia contém também um arquivo [`VERSION`](../USAGE.md#version) com a versão de referência e um [`SKILL.md`](../USAGE.md#skillmd) otimizado para carregamento rápido por IA.
