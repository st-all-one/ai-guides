...
# Namespaces no PHP 7.4

Este documento cobre os *namespaces* disponíveis no PHP 7.4. Todo o código
aqui é 100% válido e executável na versão 7.4. Os recursos de namespace não
mudaram em relação ao 7.2, mas mantemos o exemplo restrito a esta versão.

> Aviso de escopo: nada aqui é específico de versões 8.x. Alguns recursos de
> sintaxe que só surgem em versões mais recentes não estão disponíveis nesta
> versão.
...
O PHP 7.4 também permite a vírgula final dentro do grupo (vide
`10-sintaxe-recursos-74.md`).
...
| Recurso | Disponível em | Notas no 7.4 |
|---|---|---|
...
| vírgula final no `use {}` | 7.4 | inclusive nesta versão |
