...
# Geradores e Iteradores no PHP 7.4

Este documento cobre geradores e os iteradores SPL disponíveis no PHP 7.4.
Todo o código aqui é 100% válido e executável na versão 7.4.

> Aviso de escopo: nada aqui é específico de versões 8.x.
