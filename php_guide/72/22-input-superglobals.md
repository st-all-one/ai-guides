...
# Superglobais, Entrada Externa e Funções Variáveis no PHP 7.2

Este documento cobre as variáveis superglobais e o tratamento seguro de entrada
externa no PHP 7.2, além de funções variáveis. Todo o código aqui é 100% válido
e executável na versão 7.2.

> Aviso de escopo: nada aqui é específico de versões posteriores. Veja também
> `05-seguranca-baseline.md` e `14-seguranca-72.md`.
...
tempo e **não existe** no 7.2 — você sempre acessa a entrada pelas superglobais
explícitas.
...
- Prefira prepared statements para banco de dados (vide segurança base).
