...
:::note
Parameterized projects behavior has changed in version 1.18. (consulte as release notes do Playwright 1.18 sobre a breaking change de custom config options).
:::
